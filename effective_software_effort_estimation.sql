...
--
-- Host: localhost
-- Generation Time: Jan 27, 2024 at 06:15 AM
...
--
-- Database: `effective_software_effort_estimation`
--
CREATE DATABASE IF NOT EXISTS `effective_software_effort_estimation` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `effective_software_effort_estimation`;
...
('0hidtkpq6sg8j1juxq4n5ywdixt6zyxw', 'eyJ1c2VyaWQiOjJ9:1rAnBD:8cVuluXQ2THT2hhwVt1xxGxFHUOCiQS47xkQVr_3uKI', '2023-12-20 08:22:51.666990'),
...
('42igkigy8wmcat10zstlebhnrq07wn8t', 'eyJ1c2VyaWQiOjR9:1pl3OF:tCxRSzDhGdTLTg-yDylaOsfiE68DIL-wKb9HS9Lrfzs', '2023-04-22 07:53:39.113185'),
...
('59ud6holyebnt6feoro18carxx8zkaz9', 'eyJ1c2VyaWQiOjF9:1rAmhb:9_y9F0smtkRTjCyMWcvnlc_MCNv32-Z6KAgsR6etpMs', '2023-12-20 07:52:15.124649'),
...
('frur9vnb0qgvtyp8obulxz4hmsxp0x7e', 'eyJ1c2VyaWQiOjN9:1pl2os:WTNwLJFXaWtyhhnTHnvkw0RNKHOqrBU6tF8RcSCTB_A', '2023-04-22 07:17:06.209600'),
...
(2, 'Manjunath', 'tmksmanju18@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#9029,4th Cross,Rajajinagar', 'Male');
...
(12, 'Naive Bayes', '54.372623574144484'),
(13, 'SVM', '54.372623574144484'),
(14, 'Logistic Regression', '56.463878326996195'),
(15, 'Random Forest Classifier', '54.752851711026615'),
(16, 'Gradient Boosting Classifier', '55.32319391634981'),
(17, 'KNeighborsClassifier', '54.372623574144484'),
(18, 'SVM', '52.28136882129277');
...
--
-- Table structure for table `remote_user_effort_estimation_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_effort_estimation_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `track_name` varchar(300) NOT NULL,
  `size_bytes` varchar(300) NOT NULL,
  `rating_count_tot` varchar(300) NOT NULL,
  `rating_count_ver` varchar(300) NOT NULL,
  `user_rating` varchar(300) NOT NULL,
  `user_rating_ver` varchar(300) NOT NULL,
  `ver` varchar(300) NOT NULL,
  `cont_rating` varchar(300) NOT NULL,
  `prime_genre` varchar(300) NOT NULL,
  `sup_devices_num` varchar(300) NOT NULL,
  `ipadSc_urls_num` varchar(300) NOT NULL,
  `lang_num` varchar(300) NOT NULL,
  `vpp_lic` varchar(300) NOT NULL,
  `Development_Duration` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_effort_estimation_prediction`
--

INSERT INTO `remote_user_effort_estimation_prediction` (`id`, `Fid`, `track_name`, `size_bytes`, `rating_count_tot`, `rating_count_ver`, `user_rating`, `user_rating_ver`, `ver`, `cont_rating`, `prime_genre`, `sup_devices_num`, `ipadSc_urls_num`, `lang_num`, `vpp_lic`, `Development_Duration`, `Prediction`) VALUES
(1, '172.217.10.42-10.42.0.42-443-34080-6', 'eBay: Best App to Buy, Sell, Save! Online Shopping', '128512000', '262241', '649', '4', '4.5', '5.10.0', '12+', 'Shopping', '37', '5', '9', '1', '96', 'More Effort'),
(2, '163.177.93.222-10.42.0.151-80-46812-6', 'PCalc - The Best Calculator', '49250304', '1117', '4', '4.5', '5', '3.6.6', '4+', 'Utilities', '37', '5', '1', '1', '120', 'Less Effort'),
(3, '10.42.0.151-74.125.22.188-37263-5228-6', 'Ms. PAC-MAN', '70023168', '7885', '40', '4', '4', '4.0.4', '4+', 'Games', '38', '0', '10', '1', '96', 'Less Effort'),
(4, '216.58.219.202-10.42.0.151-443-36518-6', 'WeatherPro', '69079040', '1572', '34', '4', '4.5', '4.8.2', '4+', 'Weather', '37', '0', '13', '1', '579', 'More Effort');
